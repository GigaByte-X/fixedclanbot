      ...
      try{
        ...
        var embeds = [
          ...
          new MessageEmbed()
            ...
            .setImage(message.guild.banner ? message.guild.bannerURL({size: 4096}) : "https://cdn.discordapp.com/attachments/1059027263372415089/1077017465084715068/ezgif-1-cb87c525e4.gif")
        ...
        channel.send({embeds, components}).then(msg => {
          ...
          return message.reply(`✅ **Successfully setup  the Music System in:** <#${channel.id}>`)
        });
        } catch (e) {
